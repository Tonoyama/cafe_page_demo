...
def getCurrData():
    ...
    j_1 = random.randint(0, 10)
    j_2 = random.randint(0, 10)
    j_3 = random.randint(0, 10)
    j_4 = random.randint(0, 10)
    j_5 = random.randint(0, 10)

    z_1 = random.randint(10, 20)
    z_2 = random.randint(10, 20)
    z_3 = random.randint(10, 20)
    z_4 = random.randint(10, 20)
    z_5 = random.randint(10, 20)

    j_now = random.randint(0, 10)

    z_now = random.randint(10, 20)
